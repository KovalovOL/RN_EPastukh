...
export default function PrivacyPolicy() {
  ...
  const { email, password, repeatPassword, agree} = useLocalSearchParams(); // Retrieve passed data
  const [fontsLoaded, setFontsLoaded] = useState(false);
    useEffect(() => {
        async function loadFonts() {
            ...
            'Inter-Italic': require('../assets/fonts/inter/Inter_24pt-Bold.ttf'),
            });
            setFontsLoaded(true);
        }
  ...
  const handleAgree = () => {
    // Navigate back to SignUp with the same input data
    router.push({
      pathname: "/signUp",
      params: { email, password, repeatPassword, agree},
    });
  };
  ...
  return (
    <View style={styles.main}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Text style={styles.header}>Privacy Policy for єПастух</Text>
...
{"\u2022"}   Application refers to єПастух, the software program provided by the Company.{"\n"}
{"\u2022"}   Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to PL NTUU KPI of Sikorsky, Ukraine, Kyiv.{"\n"}
...
{"\u2022"}   By mail: бульвар Вацлава Гавела 41а{"\n"}
        </Text>
